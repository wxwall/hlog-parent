...
public class SocketOutputStreamNewMethods implements IHLogNewMethods,Opcodes {
    ...
    private void createSocketWrite(ClassWriter classWriter){
        ...
        mv.visitLocalVariable("headBytes", "[B", null, l22, l13, 11);
        mv.visitLocalVariable("newdatas", "[B", null, l23, l13, 12);
        ...
        mv.visitLocalVariable("this", "Ljava/net/SocketOutputStream;", null, l0, l31, 0);
        mv.visitLocalVariable("fd", "Ljava/io/FileDescriptor;", null, l0, l31, 1);
        mv.visitLocalVariable("b", "[B", null, l0, l31, 2);
        mv.visitLocalVariable("off", "I", null, l0, l31, 3);
        mv.visitLocalVariable("len", "I", null, l0, l31, 4);
        mv.visitMaxs(6, 13);
        mv.visitEnd();
    }
