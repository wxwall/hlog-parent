...
public class SocketOutputStreamNewMethods implements IHLogNewMethods,Opcodes {
    ...
    private void createGetHeader(ClassWriter classWriter){
        ...
        Label l8 = new Label();
        mv.visitLabel(l8);
        mv.visitLocalVariable("buildHeader", "Ljava/lang/reflect/Method;", null, l5, l2, 1);
        mv.visitLocalVariable("e", "Ljava/lang/Exception;", null, l6, l7, 1);
        mv.visitLocalVariable("this", "Ljava/net/SocketOutputStream;", null, l0, l8, 0);
        mv.visitMaxs(3, 2);
        mv.visitEnd();
    }
